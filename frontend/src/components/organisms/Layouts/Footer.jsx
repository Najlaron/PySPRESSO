...
// patička, na domovské stránce a workflow setup stránce
function Footer() {
    return (
        <footer className="bg-grounds mt-auto">
            <div className="flex justify-between container pt-ds-xl pb-ds-xl">
                ...
                <div>
                    ...
                    <ul className="flex flex-col gap-ds-md">
                        <li><a href="https://github.com/Najlaron/PySPRESSO" className="text-foam font-light border-transparent hover:border-b hover:border-foam">GitHub</a></li>
                        <li><a href="https://imtm.cz/core-facilities/metabolomics-core-facility" className="text-foam font-light border-transparent hover:border-b hover:border-foam">Contact</a></li>
                        {/* <li><a href="#" className="text-foam font-light border-transparent hover:border-b hover:border-foam">Documentation</a></li> */}
                    </ul>
                </div>
            ...
            <div className="container border-t-2 border-roast/40">
                <p className="text-foam/70 text-center py-ds-lg">&#xA9; Institute of Molecular And Translational Medicine</p>
            </div>
        </footer>
    );
}
