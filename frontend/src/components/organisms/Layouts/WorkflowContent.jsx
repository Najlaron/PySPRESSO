...
// pravý panel na stránce editoru workflow
function WorkflowContent({ workflow,
    ...
    // formáto pro zobrazení informací o workflow, není použito
    ...
    // místo vizualizací se otevře panel pro nastavení parametru
    if (selectedStep) {
    ...
    return (
        <main className="flex-1 min-h-0 overflow-y-auto pt-ds-lg! px-ds-xl bg-foam gap-0!">
            ...
            <div className="flex justify-between items-start gap-ds-md">
                ...
                {/* tlačítka pro export a nastavení popisu */}
            ...
            {isLoading
                ...
                : <div className="flex flex-col gap-ds-lg">
                    ...
                    {/* tlačítka pro vytvořené vizualizace */}
                    ...
                    {/* zobrazení vizualizací nebo tabulkových dat, podle toho co je vybráno                                   */}
                    {activeView?.type === "data" ? (
                    ...
                    {/* JSON pro zobrazení informace o workflow, používal se během vývoje aplikace */}
                    {/* {workflow && (
